                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><a href="#" className="text-gray-200 hover:text-white">Shop</a></li>
                                ...
                                <li><a href="/faqs" className="text-gray-200 hover:text-white">FAQs</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <form className="flex">
                                <input type="email" placeholder="Your email" className="bg-stone-700 text-white px-4 py-2 rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500 flex-grow" required />
                                <button type="submit" className="bg-stone-800 text-white px-4 py-2 rounded-r-md hover:bg-stone-900 focus:outline-none focus:ring-2 focus:ring-blue-500">Subscribe</button>
                            </form>
                        </div>
                    </div>
