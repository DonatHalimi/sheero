...
const { createProduct, getProducts, getProduct, getProductsByCategory, getProductsBySubCategory, getProductsBySubSubCategory, updateProduct, deleteProduct, deleteProducts } = require('../controllers/productController');
