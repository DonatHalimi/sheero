...
const createAttachments = (order = {}, returnRequest = {}) => {
...
function generateOrderEmailHtml(order, options = {}) {
    ...
    return `
      <div style="font-family: Outfit, sans-serif; max-width: 700px; margin: 0 auto; padding: 35px; background-color: #f5f5f5; position: relative;">
        <!-- Brand Logo -->
